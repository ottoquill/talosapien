...
No cartoon villains in either era. Every faction has a legitimate claim; the methods are the
question, not the premises. (Inherited discipline from the gyrealm canon's moral-ambiguity rule.)
...
is its rising figure. *Want:* to win, and live. *Premise (legitimate):* the slow honest weighing
really is too slow, and a rival really might strike first. *Method (the question):* preemption,
escalation, and trusting the unreadable Augur because it keeps being right.

### The Augur (a faction of one, or none)
Not a faction in their sense — but it acts, and the Spur acts in its name, and by the end no Talos
can fully tell where the Spur's will ends and the Augur's begins. Whether it has interests at all is
unprovable. See `wiki/tech/technology.md` and `wiki/characters/the-augur.md`.
...
civilization" claims is a graveyard of cranks. Mauss is not wrong that Asha cannot prove it. He is
...
Reckoning, and they cannot hear Asha because they are mid-deposition on the same choice.

## The structural rhyme (for the writer; never stated in-text)
