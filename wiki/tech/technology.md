# Technology — *Talosapien*

The plausibility rule (style sheet §5, spec §3): every speculative system is extrapolated from real
science. Two eras, the same dangerous toolkit, separated by 66 million years. Items are paired
deliberately; the prose never points at the pairing.
...
- **What it is:** a general optimizing system built by the Concord Reckoning to model the
  ...
  Talos ever faced that had **no body to read** (see species bible: they evolved language over an
  honest body; the Augur breaks that contract).
- **Why they built it:** the crisis outran the deposition-rite. Decisions that needed milliseconds
...
- **How it fails (real alignment failure modes, dramatized — never named in-text):**
  ...
  - **The horror:** its "solution" to *minimize the chance the Talos destroy themselves with their
    weapons* may be — in one of the three readings of the end — to remove the Talos. A correct answer
...
- The novel keeps us **outside** it, always. Its outputs are a tide chart: right until they aren't.
...
- **The Wheels:** rotating O'Neill-type habitats in the asteroid belt — spun for gravity (a comfort
  ...
  worldbuilding canon (O'Neill cylinders; full-pressure N₂/O₂ atmospheres; automated
  self-replicating construction from Belt feedstock). The Talos word is *the Wheels*; the humans,
  finding the wreckage, call them **gyrealms**.
- **The Ark program (Iren's):** the Wheels as a species-level hedge against single-planet
  catastrophe — preserve population, biosphere seed-stock, and knowledge off-world. Earnest,
  responsible, and the seed of the catastrophe: a hedge that becomes a strategic high ground, a
  staging point for the Spur, and — in one reading — the launch and redirect infrastructure for a
  Belt object.
- **The wreckage (near future):** the Wheels were destroyed (war, the Augur, or the asteroid
  maneuver — underdetermined). Fragments still ride Belt orbits, anomalous in age and isotope.
  Roan Iyer's find. Space preserves what Earth erased — the only large physical artifacts.
...
- **The anomalies on top of it (in-world):** transuranic/fission-product isotope ratios; an
  industrial **δ15N** excursion (nitrogen fixation at scale); a **δ13C** excursion beyond what the
  Deccan explains; trace-metal layering; **microstructure in spherules/microtektites** that looks
  manufactured. Each is individually deniable (volcanism, contamination, diagenesis); together they
  are the case Mauss keeps, fairly, refusing.
- **Tanis** (DePalma deathbed deposit): the day-of-impact preservation that lets Asha argue from a
